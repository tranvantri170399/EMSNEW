                ...
                <body>
                    ...
                    <div class="modal fade" id="myModal" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <!-- Modal content-->
                            <form:form action="/newTeacher" modelAttribute="teacherNew" enctype="multipart/form-data">
                                        ...
                                        <div>
                                            ...
                                            <div Class="form-group">
                                                ...
                                                <div Class="input-group">
                                                    ...
                                                    <form:input type="text" path="lname" classxmlns="form-control" id="InputLastname" />
                                                    <span Class="input-group-addon">Tên</span>
                                                    <form:input type="text" path="fname" classxmlns="form-control" id="InputFirstname" />
                                                </div>
                                            </div>

                                            <div clas="form-group">
                                                <label for="InputID">Image:</label> <input type="File" class="form-control" name="files" id="InputImage">
                                            </div>
                                            <div clas="form-group">
                                                <label for="InputID">Email:</label>
                                                <form:input type="text" path="email" classxmlns="form-control" id="InputEmail" />
                                            </div>

                                            <div clas="form-group">
                                                <label for="InputID">Ngày sinh</label>
                                                <form:input type="date" path="dob" classxmlns="form-control" id="InputDob" min="1980-1-1" max="2020-12-31" />
                                            </div>
                                            <div clas="form-group">
                                                <label for="InputID">Số Điện Thoại</label>
                                                <form:input type="text" path="phone" classxmlns="form-control" id="InputPhone" />
                                            </div>
                                            <div clas="form-group">
                                                <label for="InputID">Địa chỉ:</label>
                                                <form:input type="text" path="address" classxmlns="form-control" id="InputAddress" />
                                            </div>
                                            <div clas="form-group">
                                            ...
                                            <div clas="form-group">
                                                ...
                                                <form:select path="depart" classxmlxmlns="form-control" idxmlns="sel1">
                                            ...
                                            <div clas="form-group">
                                                ...
                                                <form:select path="role" classxmlxmlns="form-control" idxmlns="sel1">
