  ...
  <body class="skin-blue">
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <svg width="25px" height="25px" viewBox="0 0 16 16" class="bi bi-person" fill="currentColor" style="float: left; margin-right: 10px;">
      ...
      <div class="content-wrapper">
        <iframe src="" name="frame" style="min-width: 100%;min-height: 660px" scrolling="no"></iframe>                                                                               
